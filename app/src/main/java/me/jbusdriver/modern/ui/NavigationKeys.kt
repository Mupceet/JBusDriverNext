...
object NavigationKeys {
    ...
    const val ROUTE_LINK_MOVIES = "link_movies/{linkUrl}?title={title}"
    ...
    fun linkMovies(linkUrl: String, title: String = ""): String {
        val encoded = java.net.URLEncoder.encode(linkUrl, "UTF-8")
        val encodedTitle = java.net.URLEncoder.encode(title, "UTF-8")
        return "link_movies/$encoded?title=$encodedTitle"
    }
}
